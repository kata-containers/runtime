...
DEFPCICOLDPLUGGROUPS :=
DEFPCICOLDPLUGDEVOPTS :=
...
USER_VARS += DEFPCICOLDPLUGGROUPS
USER_VARS += DEFPCICOLDPLUGDEVOPTS
...
const defaultPCIColdplugGroups = "$(DEFPCICOLDPLUGGROUPS)"
const defaultPCIColdplugDeviceOpts = "$(DEFPCICOLDPLUGDEVOPTS)"
...
$(GENERATED_FILES): %: %.in Makefile VERSION
	$(QUIET_CONFIG)$(SED) \
		...
		-e "s|@DEFPCICOLDPLUGGROUPS@|$(DEFPCICOLDPLUGGROUPS)|g" \
		-e "s|@DEFPCICOLDPLUGDEVOPTS@|$(DEFPCICOLDPLUGDEVOPTS)|g" \
		$< > $@
